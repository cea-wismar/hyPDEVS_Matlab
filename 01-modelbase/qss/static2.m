...
classdef static2 < atomic
    ...
    methods
        %% constructor method
        function obj = static2(name,x,y,s,elapsed) %  name,x,y,c_states,c_x,c_y,s,elapsed required
            ...
            elseif nargin==5
                disp('atomic model of class static1 successfully generated');
            else
