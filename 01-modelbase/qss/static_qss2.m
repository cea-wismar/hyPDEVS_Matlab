...
classdef static_qss2 < atomic
    ...
    methods
        %% constructor method
        function obj = static1(name,x,y,s,elapsed) %  name,x,y,c_states,c_x,c_y,s,elapsed required
            ...
            elseif nargin==5
                disp('atomic model of class static_qss2 successfully generated');
            else
                disp('mistake at constructor method for class static_qss2');
            end
            % end example
        end
        ...
        function obj = lambdafun(obj) 
            ...
            obj.y.p1 = -9.81;
            %y=struct('p1',-9.81-0.1/1*s.y1dot-s.sw*(30/1*s.y1dot+100000/1*(s.y-floor(10+1-s.x))));
