%% COUPLED PDEVS cm_c2
%  stored in DEVS_PATH/01-modelbase/cm_c2.m

%%
classdef cm_c2 < coupled
    %% Description
    ...
    % cm_c2(name,service_time1, service_time2)|
    %
    %% Superclass
    % |coupled|
   ...
   %% Inherited Properties 
    ...
    %    
    %% Ports
    % has for inputs |x|: p1,p2,p3,p4 for incoming workpieces
    %
    % has two outputs |y|: out1, out2 to emit assembled parts
    %
    %% Subcomponents
...
%
    ...
    methods
        function obj = cm_c2(name,varargin) 
            ...
            set_x_ports(obj, {'p1','p2','p3','p4'});
            
            % add portnames must be unique on this level
            set_y_ports(obj, {'out1','out2'});
