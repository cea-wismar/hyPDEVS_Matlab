...
classdef am_transducer < atomic
    ...
    %
   methods
       function obj = am_transducer(name,inistates,elapsed)
           if nargin == 3
               ...
               error('mistake at constructor method for class am_transducer');
           end
       ...
       function deltaextfun(obj,gt)
           ...
           obj.s.q = obj.s.q + obj.x.p1{1};% count the job from input port p1
