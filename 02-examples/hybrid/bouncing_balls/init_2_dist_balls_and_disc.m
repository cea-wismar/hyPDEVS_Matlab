...
% call: init_2_dist_balls_and_disc
...
% to generate an fake internal event
a_type = 'am_interrupter';
a_name = 'interrupt';
x_d = [];
y_d = struct('yd_p1',[]);
c_states = [];
...
c_y = [] ;
s_d = struct('sigma',3);
    MODELBASE.interrupt = {a_type,a_name,x_d,y_d,c_states,c_x,c_y,s_d,elapsed};
...
Dc_model = {};
Da_model = {'bb_1','bb_2','bb_3','bb_4','interrupt'};
