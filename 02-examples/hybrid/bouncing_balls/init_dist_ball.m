...
Dc_model = {};
Da_model = {'bb_1','bb_2'};
Zid_model = {'bb_1','yd_p1','bb_2','xd_p1'};% discrete couplings
CZid_model = {'bb_2',1,'bb_1',1};% continuous couplings --> bb_2 outputs the velocity, which is needed by bb_1 as derivation
%%        
...
%  root_model = r_c_hybrid(root_model,tstart,tend)
